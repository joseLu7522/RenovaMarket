...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" data-interval="1">
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        ...
        <img src="{{ asset('img/Carousel/carousel2.jpg') }}" class="d-block w-100 carousel-image" alt="...">
      </div>
      <div class="carousel-item">
        <div class="dark-overlay d-flex align-items-start justify-content-center">
          <div class="carousel-caption text-light">
        ...
        <img src="{{ asset('img/Carousel/carousel3.jpg') }}" class="d-block w-100 carousel-image" alt="...">
      </div>
    </div>
</div>
