        ...
        <div class="col-lg-12">
            <section class="dark-grey-text">
                                ...
                                <td>
                                    <form action="{{ route('cart.update') }}" method="POST">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <button class="btn btn-sm btn-primary btn-rounded"><i class="bi bi-pencil-square"></i>
                                            </button>
                                    </form>
                                    <form action="{{ route('cart.remove') }}" method="POST">
                                        {{ csrf_field() }}
                                        <input type="hidden" value="{{ $item->id }}" id="id" name="id">
                                        <button class="btn btn-sm btn-danger btn-rounded"><i class="bi bi-trash3"></i>
                                        </button>
                                    </form>
                </div>
                </td>
                ...
                <div class="form-group text-center">
                    ...
                    <a href="{{ route('home') }}" class="btn btn-primary btn-rounded">Proceder al CheckOut</a>
                    <a href="{{ route('home') }}" class="btn btn-success btn-rounded">Seguir comprando</a>
                </div>
        </div>
        </section>
    </div>
